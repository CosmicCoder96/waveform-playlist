	...
	var AnnotationList = function () {
	  ...
	  _createClass(AnnotationList, [{
	    ...
	    value: function setupEE(ee) {
	      ...
	      ee.on('annotationsrequest', function (host, transcription) {
	        _this2.export(host, transcription);
	      });
	    ...
	    key: 'export',
	    value: function _export(host, transcription) {
	      var bannotations = this.annotations;
	      var annotationSpeakerHTML = document.getElementsByClassName('annotation-speaker');
